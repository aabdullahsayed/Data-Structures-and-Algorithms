...
**Topic:** Two Pointers
**Difficulty:** Medium
**Solution file:** [`024-Four-Sum-Basic.java`](./024-Four-Sum-Basic.java)

## Problem

Given an array, find all unique quadruplets [a, b, c, d] that sum up to a given target.
...
See [`024-Four-Sum-Basic.java`](./024-Four-Sum-Basic.java) in this folder — implement the `TODO` inside `FourSumBasic.fourSumBasic(...)`
