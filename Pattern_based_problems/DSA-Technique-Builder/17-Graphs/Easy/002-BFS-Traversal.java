 ...
 *
 * Problem:
 * Given a graph and a starting node, perform a breadth-first traversal and return the order in
 ...
 * Output: [2,0,1,3]
 *
 * Technique: Graph representation and traversal (BFS/DFS), shortest paths, connectivity.
 * Hint: Decide: adjacency list or matrix? BFS (shortest path/levels) or DFS (exploration/backtracking)?
 */
public class BFSTraversal {

    /**
     * TODO: implement using Graphs.
     ...
     */
    public static int bfsTraversal(int[] arr) {
        // TODO: implement
        return -1;
    }
    ...
    public static void main(String[] args) {
        ...
        int[] sample = {};
        System.out.println(BFSTraversal.bfsTraversal(sample));
    }
}
