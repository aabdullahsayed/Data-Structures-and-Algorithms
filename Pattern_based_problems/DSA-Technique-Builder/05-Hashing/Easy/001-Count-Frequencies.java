 ...
 *
 * Problem:
 * Given an array, count the frequency of each distinct element using a hash map.
 *
 * Example:
 * Input:  arr = [1,2,2,3,3,3]
 * Output: {1:1, 2:2, 3:3}
 *
 * Technique: Use hash maps/sets for O(1) average lookups to avoid brute-force nested loops.
...
public class CountFrequencies {
    ...
    public static void main(String[] args) {
        ...
        int[] sample = {};
        System.out.println(CountFrequencies.countFrequencies(sample));
    }
}
