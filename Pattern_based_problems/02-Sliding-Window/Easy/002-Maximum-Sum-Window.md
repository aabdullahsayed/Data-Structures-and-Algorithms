# 002. Maximum Sum Window

**Topic:** Sliding Window
**Difficulty:** Easy
**Solution file:** [`002-Maximum-Sum-Window.java`](./002-Maximum-Sum-Window.java)
...
See [`002-Maximum-Sum-Window.java`](./002-Maximum-Sum-Window.java) in this folder — implement the `TODO` inside `MaximumSumWindow.maximumSumWindow(...)`
