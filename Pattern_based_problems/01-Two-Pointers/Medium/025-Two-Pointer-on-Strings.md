# 025. Two Pointer on Strings

**Topic:** Two Pointers
**Difficulty:** Medium
**Solution file:** [`025-Two-Pointer-on-Strings.java`](./025-Two-Pointer-on-Strings.java)
...
See [`025-Two-Pointer-on-Strings.java`](./025-Two-Pointer-on-Strings.java) in this folder — implement the `TODO` inside `TwoPointerOnStrings.twoPointerOnStrings(...)`
